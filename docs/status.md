...
- No CI pipeline definition is committed yet; the matrix is run manually
  (see [development.md](development.md)).
- No license file: the license is the owner's decision.
- Benchmarks exist without recorded baselines.
- Fuzz targets have only been run for short periods (10 to 15 seconds).
